...
angular.module('travel')
    .factory('themeService', function ($timeout) {
        ...
        /**
         * From theme-scripts.js document.ready Callbacl
         * Configure Calendar on document.ready 
         * 
         * */
        ...
        /**
         * From theme-scripts.js
         * middle block plugin(set image in the middle of its parent object)
         * This is ran once in common configuration
         */
        var setUpMiddleBlockPlugin = function () {
         ...
         * This is ran once in common configuration
         */
        var setUpJqueryCountPlugin = function () {
            /* jQuery CounTo plugin */
            (function (a) {
        ...
        /**
         * From theme-scripts.js
         * Configure SoapPopup plugin
         * This is ran once in common configuration
         */
        var setUpSoapPopUpPlugin = function () {
         ...
         * This is a private function which is ran once onReadyCallback1
         */
        var configureInputElements = function () {
        ...
        var configureDateElements = function () {
            // datepicker
         ...
         * This is a private function which is called 3 times
         */
        var displayPhotoGallery = function ($item) {
         ...
         * This is a private function which is called 3 times
         */
        var displayImageCarousel = function ($item) {
            if (!tjq.fn.flexslider || $item.length < 1 || $item.is(":hidden")) {
                return;
            }
            var dataAnimation = $item.data("animation");
         ...
         * From theme-scripts.js
         *  Position Mega Menu
         * This is a private function which is once in common configuration
         */
        var fixPositionMegaMenu = function (parentObj) {
         ...
         * From index.html
         * On Ready Callback 
         * it is to be called on home route only after timeout 0 or ng-init
         * */
        var configureRevolutionSlider = function () {
        ...
        var onLoadCallback1 = function () {
            ...
            // middle block
            /*undefined handling by inder */
            // var middleBlockElements = tjq(".middle-block");
        ...
        var enableChaser;
        /**
         * One Time configuration tasks from theme-scripts which only
         * need to run 1 time
         */
        var configureCommmon = function () {
            ...
            setUpMiddleBlockPlugin();
            setUpJqueryCountPlugin();
            setUpStagePlugin();
            setUpSoapPopUpPlugin();
        ...
        var runThemeOnReadyCallbacks = function () {
            onReadyCallback1();
            onReadyCallback2();
        };

        var runWindowOnLoadCallbacks = function () {
            onLoadCallback1();
        }

        configureCommmon();
        //tjq(window).load(runWindowOnLoadCallbacks);
        // Public API here
        var isMobileScreen = function () {
            return stGlobals.isMobile || stGlobals.isIOS || stGlobals.isMobileWebkit;
        }
        var openSelect = function (selector) {
            var element = angular.element(selector)[0], worked = false;
            ...
            if (!worked) { // unknown browser / error
                console.log("Focusing select didn't worked in your browser.");
            }
        }
        return {
            configureCalendar: configureCalendar,
            configureRevolutionSlider: configureRevolutionSlider,
            runThemeOnReadyCallbacks: runThemeOnReadyCallbacks,
            runWindowOnLoadCallbacks: runWindowOnLoadCallbacks,
            isMobileScreen: isMobileScreen,
            openSelect: openSelect,
            configureDateElements : configureDateElements
        };
    });
