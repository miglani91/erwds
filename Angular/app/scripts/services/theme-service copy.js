...
angular.module('travel')
  .factory('themeService', function ($timeout) {
        /**
         * From theme-scripts.js document.ready Callback
         * Configure price slider on document.ready 
         * 
         * */
        var configurePriceSlider = function () {
            $timeout(function () {
        ...
        /**
         * From theme-scripts.js
         * changeTraveloElementUI function
         * This is a private function which is ran once onReadyCallback1
         */
        var changeTraveloElementUI = function () {
        ...
        // Public API here
        return {
            configurePriceSlider: configurePriceSlider,
